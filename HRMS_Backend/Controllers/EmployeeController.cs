...
public class UpdateResignationStatusRequest
{
    ...
    request.IsHRReject);
        ...
        //    return Ok(logs);
        //}
        [HttpGet("GetEmployeePersonalDetails")]
        public async Task<IActionResult> GetEmployeePersonalDetails(int companyId, int regionId)
        {
            try
            {
                var result = await _employeeService
                    .GetEmployeePersonalDetailsAsync(companyId, regionId);
        ...
        [HttpGet("GetEmployeeFamilyDetails")]
        public async Task<IActionResult> GetEmployeeFamilyDetails(int companyId, int regionId)
        {
            return Ok(await _employeeService.GetEmployeeFamilyDetailsAsync(companyId, regionId));
        }
        [HttpGet("GetEmployeeEmergencyContacts")]
        public async Task<IActionResult> GetEmployeeEmergencyContacts(int companyId, int regionId)
        {
            return Ok(await _employeeService.GetEmployeeEmergencyContactsAsync(companyId, regionId));
        }
        [HttpGet("GetEmployeeReferences")]
        public async Task<IActionResult> GetEmployeeReferences(int companyId, int regionId)
        {
            return Ok(await _employeeService.GetEmployeeReferencesAsync(companyId, regionId));
        }
