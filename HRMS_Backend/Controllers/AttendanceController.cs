...
namespace HRMS_Backend.Controllers
{
    ...
    [FromQuery] DateOnly toDate)
     ...
     [FromBody] ClockInOutCreateDto dto)
        ...
        public async Task<IActionResult> Create([FromBody] BreakPolicyCreateDto dto)
        {
            var result = await _breakPolicyService.CreateAsync(dto);
            return Ok(result);
        }
        ...
        public async Task<IActionResult> Update([FromBody] BreakPolicyUpdateDto dto)
        {
            var result = await _breakPolicyService.UpdateAsync(dto);
            return Ok(result);
        }
        ...
        public async Task<IActionResult> Delete([FromBody] BreakPolicyDeleteDto dto)
        {
            var result = await _breakPolicyService.DeleteAsync(dto);
            return Ok(result);
        }
        ...
        [HttpGet("GetBreakPolicyAll/{userId}")]
        public async Task<IActionResult> GetAll(int userId)
        {
            var result = await _breakPolicyService.GetAllAsync(userId);
        ...
        [HttpGet("GetBreakPolicyById/{id}")]
        public async Task<IActionResult> GetById(int id)
        {
            var result = await _breakPolicyService.GetByIdAsync(id);
        ...
        /// </summary>
        [HttpPost("BreakIn")]
        public async Task<IActionResult> BreakIn([FromBody] BreakInDto dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);

            var result = await _breakPolicyService.BreakInAsync(dto);
        ...
        /// </summary>
        [HttpPost("BreakOut")]
        public async Task<IActionResult> BreakOut([FromBody] BreakOutDto dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);

            var result = await _breakPolicyService.BreakOutAsync(dto);
