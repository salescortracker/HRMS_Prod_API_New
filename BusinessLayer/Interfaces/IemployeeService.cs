...
namespace BusinessLayer.Interfaces
{
    public interface IemployeeService
    {
        ...
        Task<List<EmployeePersonalDetailsDto>> GetEmployeePersonalDetailsAsync(int companyId, int regionId);
        Task<List<EmployeeFamilyDetailsDto>> GetEmployeeFamilyDetailsAsync(int companyId, int regionId);

        Task<List<EmployeeEmergencyContactDto>> GetEmployeeEmergencyContactsAsync(int companyId, int regionId);
        Task<List<EmployeeReferenceDto>> GetEmployeeReferencesAsync(int companyId, int regionId);
    }
}
