...
into gradeJoin
    ...
    into deptJoin
        ...
        public async Task<List<EmployeePersonalDetailsDto>> GetEmployeePersonalDetailsAsync(int companyId, int regionId)
        {
            try
            {
                var result = await _context.EmployeePersonalDetails
                    ...
                    .Select(x => new EmployeePersonalDetailsDto
                    {
                        Id = x.Id,
        ...
        public async Task<List<EmployeeFamilyDetailsDto>> GetEmployeeFamilyDetailsAsync(int companyId, int regionId)
        {
            return await _context.EmployeeFamilyDetails

                .Where(x => x.CompanyId == companyId &&
                          x.RegionId == regionId)

                .Select(x => new EmployeeFamilyDetailsDto
                {
                    FamilyId = x.FamilyId,
                    CompanyID = x.CompanyId,
                    RegionID = x.RegionId,
        ...
        public async Task<List<EmployeeEmergencyContactDto>>
GetEmployeeEmergencyContactsAsync(int companyId, int regionId)
        {
        ...
        public async Task<List<EmployeeReferenceDto>>
GetEmployeeReferencesAsync(int companyId, int regionId)
        {
            ...
            .Select(x => new EmployeeReferenceDto
            {
